...
public class Solution {
    ...
    public static class DataAdapter implements RowItem {
        ...
        @Override
        public String getCountryCode() { // еще слуожность тут, нужно перебрать мапу итератором, в каждой паре ключ-значение
            // сравнивать значение с искомым и если оно совпадает, то извлечь ключ
        ...
        public String getContactFirstName() {
            String cont = contact.getName();
            return cont.substring(cont.lastIndexOf(" ")+1);
        }

        @Override
        public String getContactLastName() {
            String cont = contact.getName();
            return cont.substring(0, cont.indexOf(","));
        }

        @Override
        public String getDialString() {
            String transform = contact.getPhoneNumber();
            String str = transform.replaceAll("\\D+",""); // вся соль задачи в этом регулярном выражении,
            // оно удаляет из исходной строки все символы кроме цифр

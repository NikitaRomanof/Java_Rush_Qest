...
public class Solution {
    ...
    public static class IncomeDataAdapter implements  Customer, Contact {
        ...
        public String getPhoneNumber() {
            String phoneN1 = String.format("%+d", data.getCountryPhoneCode());
            String phoneN2 = String.format("%010d", data.getPhoneNumber());
            String phoneN3 = phoneN2.substring(0,3);
            String phoneN4 = phoneN2.substring(3,6);
            String phoneN5 = phoneN2.substring(6,8);
            String phoneN6 = phoneN2.substring(8,10);

             // тут нужно отформатировать строку что бы из 2х этих числовых значений получилась строка определенного вида

            return phoneN1+"("+phoneN3+")"+phoneN4+"-"+phoneN5+"-"+phoneN6;
        }
    }

...
public class Solution {
    public static void main(String[] args) throws IOException {
        ...
        while(true) {
            ...
            try (FileInputStream inputStream = new FileInputStream(line);) { // вся соль задачи по сути в этом трай катч, он называется трай с ресурсами
                // тут создание потока чтения идет в круглых скобках а не в основном блоке, это знвчит что трай сам закроет потом поток

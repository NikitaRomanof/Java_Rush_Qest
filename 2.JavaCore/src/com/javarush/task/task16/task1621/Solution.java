...
public class Solution {
    ...
    public static class ThreadNamePrinter extends Thread {
        ...
        public void printMsg() {
            Thread t = Thread.currentThread();// тут переменная t возвращает ссылку на текущий запущенный поток, который вызывает этот метод
            String name = t.getName(); // данный метод получает имя методов обэекта

...
public class Solution {
    ...
    public static void main(String[] args) throws InterruptedException {
        StringBuffer expectedResult = new StringBuffer();/*Чтобы справиться с созданием временного мусора
        из-за модификаций объекта String, можно использовать класс StringBuffer.
...
StringBuffer(String str) — создаст объект на основе переменной str (содержащий все символы str в той же последовательности)*/
        ...
        for (int i = 1000 - 1; i >= 0; i--) {
            expectedResult.append(i).append(" "); /*Конкатенация строк через StringBuffer в Java выполняется с помощью метода append.
...
Метод append возвращает объект, на котором был вызван (как и многие другие методы),
что позволяет вызывать его “цепочкой”. Пример выше можно написать так:sb.append(new Integer(2))
            .append("; ")
            .append(false)
            .append("; ")
    ...
    КОРОЧЕ ОН СКЛАДЫВАЕТ ВСЕ В СТРОКУ*/

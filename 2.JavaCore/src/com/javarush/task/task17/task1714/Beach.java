...
public class Beach implements Comparable<Beach> {
    ...
    @Override
    public synchronized int compareTo(Beach o) { // все решение тут, фактически простая реализация метода compareTo()
      int a = 0;
      int b = 0;
      int c = 0;
      a = (int) (this.getDistance() -  o.getDistance());
      b = this.getQuality() -  o.getQuality();
      c = a - b;
        return c;
    }
}

...
public class Solution {
    ...
    private synchronized void method4() {
        sb.append(1).append(1).append(1).append(1); // Метод append возвращает объект, на котором был вызван (как и многие другие методы), что позволяет вызывать его “цепочкой”.
    }

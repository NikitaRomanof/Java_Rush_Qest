...
public class Solution {
    public static void main(String[] args) throws InterruptedException {
        ...
        counter1.start();
        counter1.join(); // тут тормозим выполнение мэйна, пока первый поток не выполнит свою работу, соответственно мэйн не может запустить следущий поток
        counter2.start();
        counter2.join(); // аналогично тут и далее
        counter3.start();
        counter3.join();
        counter4.start();
        counter4.join();
